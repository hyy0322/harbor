...
func (base *Base) setDriverName(e error) error {
	...
	case storagedriver.InvalidOffsetError:
		actual.DriverName = base.StorageDriver.Name()
		return actual
	case storagedriver.BadRequestError:
		actual.DriverName = base.StorageDriver.Name()
		return actual
	case storagedriver.ForbiddenError:
		actual.DriverName = base.StorageDriver.Name()
		return actual
	case storagedriver.RequestTimeoutError:
		actual.DriverName = base.StorageDriver.Name()
		return actual
	case storagedriver.TooManyRequestsError:
		actual.DriverName = base.StorageDriver.Name()
		return actual
	case storagedriver.NotFoundError:
		actual.DriverName = base.StorageDriver.Name()
		return actual
	case storagedriver.InvalidRangeError:
		actual.DriverName = base.StorageDriver.Name()
		return actual
	case storagedriver.PreconditionError:
		actual.DriverName = base.StorageDriver.Name()
		return actual
	case storagedriver.ConflictError:
		actual.DriverName = base.StorageDriver.Name()
		return actual
	default:
