...
require (
	code.byted.org/security/go-polaris v1.31.13
...
require (
	code.byted.org/gopkg/env v1.4.17 // indirect
...
replace (
	...
	github.com/docker/distribution => code.byted.org/infcp/cr-distribution v2.38.0+incompatible
